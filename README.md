...
open-world map full of houses, chests, and loot — whoever has the most
kills when the 5-minute clock runs out wins the round.
...
- **Positional audio:** every gunshot in the match is audible to everyone,
  ...
  you is loud and centered.
- **Health, death, and respawn:** get shot enough and you go down for 3
  seconds (with a death/respawn animation), then respawn with your loadout
  intact. Join mid-round, or leave and rejoin, and you'll spectate (cycle
  between active players' viewpoints) until the round ends, then join in
  for real.
...
- **Look:** hazard-tape visual style, Bebas Neue/Space Mono type, a color
  shop so everyone can pick their own player color, and player animations
  (walk bob, fire recoil, hit flash, death/respawn) throughout.
